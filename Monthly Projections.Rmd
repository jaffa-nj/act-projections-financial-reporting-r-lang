...
proj.env$underwriting_lalaes <- read.csv(
...
if (any(!proj.env$underwriting_lalaes$KEY %in% proj.env$treaty_positions$KEY)) {
  proj.env$missing_keys <- unique(proj.env$underwriting_lalaes$KEY[!proj.env$underwriting_lalaes$KEY %in% proj.env$treaty_positions$KEY])
  stop(paste(
...
if (any(!proj.env$treaty_positions$KEY %in% proj.env$underwriting_lalaes$KEY)) {
  proj.env$missing_keys <- unique(proj.env$treaty_positions$KEY[!proj.env$treaty_positions$KEY %in% proj.env$underwriting_lalaes$KEY])
  stop(paste(
...
proj.env$treaty_positions <- proj.env$treaty_positions %>%
  inner_join(
    proj.env$underwriting_lalaes,
    by = c("KEY")
  )
