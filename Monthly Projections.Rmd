...
proj.env$treaty_positions <- openxlsx::readWorkbook(
    xlsxFile = paste(params$reporting_path, params$underwriting_master, sep = ""),
    sheet = "All Treaties"
  ) %>%
  rename(
    KEY = ConcatenatedKey
  ...
  mutate(
    EffectiveDate = openxlsx::convertToDate(EffectiveDate),
    ExpirationDate = openxlsx::convertToDate(ExpirationDate),
