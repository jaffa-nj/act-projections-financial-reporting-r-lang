...
proj.env$total_wp_monthly <- sum(proj.env$MonthlyProjections$WP_Monthly, na.rm = TRUE) - sum(proj.env$MonthlyProjections$WP_ToEarnNextTreaty, na.rm = TRUE)
proj.env$total_ep_monthly <- sum(proj.env$MonthlyProjections$EP_Monthly, na.rm = TRUE) 
